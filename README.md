...
During the creation of my project, I created a progrm that analyizes information from a Kaggle data group within 4 text files. The informationg ets organized ino a class called UserStory. This program stores the spe
